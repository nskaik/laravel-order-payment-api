...
return [
    ...
    'auth' => [
        ...
        'extra_info' => 'Obtain your JWT token by registering or logging in via the Authentication endpoints. Include the token in the Authorization header as: <code>Bearer {token}</code>',
    ],
